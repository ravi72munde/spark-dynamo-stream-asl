...
import org.apache.spark.streaming.kinesis.dynamostream.{KinesisInitialPosition, KinesisInitialPositions}
...
object KinesisInputDStream {
  ...
  class Builder {
    ...
    // Switch to DynamoStream
    private var isDynamoDBStream:Boolean = false
